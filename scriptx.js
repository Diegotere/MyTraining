...
function createSvg() {
  ...
  var chalk = boardSvg.append("defs")
                      ...
                      .attr("height", "100%")
                      .append("image")
                      .attr("xlink:href", "https://i.imgur.com/AQo3EyN.jpg")
                      .attr("x", "-1250")
                      .attr("y", "-30")
                      .attr("width", "3000px")
                      .attr("height", "130%");
...
function appendX(cellX, cellY) {
  ...
  var chalkAudioX = new Audio("http://mboxmp3.com/u/chalk_x.mp3");
...
function appendO(cellX, cellY) {
  ...
  var chalkAudioO = new Audio("http://mboxmp3.com/u/chalk_o.mp3");
